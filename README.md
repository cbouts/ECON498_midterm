...
### Step 1:
Request data by running [cmcap_coingecko_request.py](https://github.com/cbouts/ECON498_midterm/blob/main/cmcap_coingecko_request.py). This file requests the most important data from Coingecko using API and from Coinmarketcap using screen scraping. First, the file creates the folders which will hold html files from Coinmarketcap and the json files from Coingecko: 
```
...
Parse the data.
#### Step 2A:
Run [coingecko_parse.py](https://github.com/cbouts/ECON498_midterm/blob/main/coingecko_parse.py). This creates the folder 'coingecko_parsed_files' which will hold our new coingecko csv:
```
...
`df.to_csv('coingecko_parsed_files/coingecko_dataset.csv')`. This csv is here: [coingecko_dataset.csv](https://github.com/cbouts/ECON498_midterm/blob/main/data_analysis/coingecko_dataset.csv). (Note that we've since moved it to the data_analysis folder because it is easier to use for analysis if it's in this folder.)

#### Step 2B:
Run [cmcap_parse.py](https://github.com/cbouts/https://github.com/cbouts/ECON498_midterm/blob/main/data_analysis/coingecko_dataset.csv/blob/main/cmcap_parse.py). This creates the folder 'cmc_parsed_files' which will hold our new coingecko csv:
```
...
This csv is here: [cmc_dataset.csv](https://github.com/cbouts/ECON498_midterm/blob/main/data_analysis/cmc_dataset.csv). (Note that we've since moved it to the data_analysis folder because it is easier to use for analysis if it's in this folder.)


### Step 3: 
Run [cmcap_deeplink.py](https://github.com/cbouts/ECON498_midterm/blob/main/cmcap_deeplink.py) to request deep link information from coinmarketcap for each coin that features on the top 500 list over the time period of interest. This file first creates the file that will hold these html files:
```
if not os.path.exists("deep_link_html"):
	os.mkdir("deep_link_html")
```
Next, the file reads [cmc_dataset.csv](https://github.com/cbouts/ECON498_midterm/blob/main/data_analysis/cmc_dataset.csv). Again, I've included `context = ssl._create_unverified_context()` and `context=context`, but you may be able to omit these.
```
...
for link in df['link']:
	...
	if os.path.exists("deep_link_html/" + filename + ".html"):
		...
		time.sleep(30)
```
The resultant csv can be found here: [cmc_deeplink.csv](https://github.com/cbouts/ECON498_midterm/blob/main/data_analysis/cmc_deeplink.csv).


### Step 4: 
Parse the deep link information by running [cmcap_deeplink_parse.py](https://github.com/cbouts/ECON498_midterm/blob/main/cmcap_deeplink_parse.py). The file first creates the file that will hold the new csv of deep link information if it does not already exist:
```
if not os.path.exists("cmc_parsed_files"):
	os.mkdir("cmc_parsed_files")
```
...
The resultant csv is found here: [cmc_deeplink.csv](https://github.com/cbouts/ECON498_midterm/blob/main/data_analysis/cmc_deeplink.csv). (Note that we've since moved it to the data_analysis folder because it is easier to use for analysis if it's in this folder.)


### Step 5: 
Create a new folder, [data_analysis](https://github.com/cbouts/ECON498_midterm/tree/main/data_analysis). We will now analyze the data on the 3 csvs, so we move them into the new folder because this is where we will be using them. A detailed write-up about the processes used and analysis completed in this step is available at [data_analysis.md](https://github.com/cbouts/ECON498_midterm/blob/main/data_analysis.md).
#### Step 5A:
Run [cleaning.py](https://github.com/cbouts/ECON498_midterm/blob/main/data_analysis/cleaning.py) to determine how much data for each variable is missing. This file reads each of our 3 CSVs in turn, identifies the percentage of data missing in each column of each CSV, and prints the results in the terminal output. My results for this are presented in [data_analysis.md](https://github.com/cbouts/ECON498_midterm/blob/main/data_analysis.md).
#### Step 5B: 
Run [summary_statistics.py](https://github.com/cbouts/ECON498_midterm/blob/main/data_analysis/summary_statistics.py) to get summary statistics for price, market cap, and volume for each coin from each website using [coingecko_dataset.csv](https://github.com/cbouts/midterm_project/blob/main/ECON498_midterm/coingecko_dataset.csv) and [cmc_dataset.csv](https://github.com/cbouts/ECON498_midterm/blob/main/data_analysis/cmc_dataset.csv). For each csv, the file identifies information about market cap, volume, and price for each coin and identifies the mean, standard deviation, minimum, and maximum. With this information, the file creates 6 new CSVs of summary statistics:
- for Coinmarketcap:
  - [price_cmc.csv](https://github.com/cbouts/ECON498_midterm/blob/main/data_analysis/price_cmc.csv)
  - [volume_cmc.csv](https://github.com/cbouts/ECON498_midterm/blob/main/data_analysis/volume_cmc.csv)
  - [market_cap_cmc.csv](https://github.com/cbouts/ECON498_midterm/blob/main/data_analysis/market_cap_cmc.csv)
- for Coingecko:
  - [price_gecko.csv](https://github.com/cbouts/ECON498_midterm/blob/main/data_analysis/price_gecko.csv)
  - [volume_gecko.csv](https://github.com/cbouts/ECON498_midterm/blob/main/data_analysis/volume_gecko.csv)
  - [market_cap_gecko.csv](https://github.com/cbouts/ECON498_midterm/blob/main/data_analysis/market_cap_gecko.csv)
#### Step 5C:
...
- [Means__Prices_1.png](https://github.com/cbouts/ECON498_midterm/blob/main/data_analysis/Means_Prices_1.png)
- [Mean_Price_2.png](https://github.com/cbouts/ECON498_midterm/blob/main/data_analysis/Mean_Price_2.png)
- [Mean_Volumes_1.png](https://github.com/cbouts/ECON498_midterm/blob/main/data_analysis/Mean_Volumes_1.png)
- [Mean_Volumes_2.png](https://github.com/cbouts/ECON498_midterm/blob/main/data_analysis/Mean_Volumes_2.png)
- [Means_Market_Cap.png](https://github.com/cbouts/ECON498_midterm/blob/main/data_analysis/Means_Market_Cap.png)

These graphs are analyzed in [data_analysis.md](https://github.com/cbouts/ECON498_midterm/blob/main/data_analysis.md).
#### Step 5D:
Make use of the time dimension of our data by using [cmc_dataset.csv](https://github.com/cbouts/ECON498_midterm/blob/main/data_analysis/cmc_dataset.csv) and [gecko_dataset.csv](https://github.com/cbouts/ECON498_midterm/blob/main/data_analysis/gecko_dataset.csv) to make graphs in Excel tracking each site's reportings of price, volume, and market cap over the 48 hour time period for the coins Bitcoin (BTC, ranked first by market cap), Digibyte (DGB, ranked around 50th by market cap), Bytom (BTM, ranked around 100th by market cap), AdEx (ADX, ranked around 200th by market cap), and ARPA Chain (ARPA, ranked around 300th by market cap).
The resultant graphs are:
- For BTC:
  - Price: [BTC_price.png](https://github.com/cbouts/ECON498_midterm/blob/main/data_analysis/BTC_price.png)
  - Market Cap: [BTC_mc.png](https://github.com/cbouts/ECON498_midterm/blob/main/data_analysis/BTC_mc.png)
  - Volume: [BTC_volume.png](https://github.com/cbouts/ECON498_midterm/blob/main/data_analysis/BTC_volume.png)
- For DGB:
  - Price: [DGB_price.png](https://github.com/cbouts/ECON498_midterm/blob/main/data_analysis/DGB_price.png)
  - Market Cap: [DGB_mc.png](https://github.com/cbouts/ECON498_midterm/blob/main/data_analysis/DGB_mc.png)
  - Volume: [DGB_volume.png](https://github.com/cbouts/ECON498_midterm/blob/main/data_analysis/DGB_volume.png)
- For BTM:
  - Price: [BTM_price.png](https://github.com/cbouts/ECON498_midterm/blob/main/data_analysis/BTM_price.png)
  - Market Cap: [BTM_mc.png](https://github.com/cbouts/ECON498_midterm/blob/main/data_analysis/BTM_mc.png)
  - Volume: [BTM_Volume.png](https://github.com/cbouts/ECON498_midterm/blob/main/data_analysis/BTM_Volume.png)
- For ADX:
  - Price: [ADX_price.png](https://github.com/cbouts/ECON498_midterm/blob/main/data_analysis/ADX_price.png)
  - Market Cap: [ADX_mc.png](https://github.com/cbouts/ECON498_midterm/blob/main/data_analysis/ADX_mc.png)
  - Volume: [ADX_volume.png](https://github.com/cbouts/ECON498_midterm/blob/main/data_analysis/ADX_volume.png)
- For ARPA:
  - Price: [ARPA_price.png](https://github.com/cbouts/ECON498_midterm/blob/main/data_analysis/ARPA_price.png)
  - Market Cap: [ARPA_mc.png](https://github.com/cbouts/ECON498_midterm/blob/main/data_analysis/ARPA_mc.png)
  - Volume: [ARPA_volume.png](https://github.com/cbouts/ECON498_midterm/blob/main/data_analysis/ARPA_volume.png)

These graphs are examined and analyzed in [data_analysis.md](https://github.com/cbouts/ECON498_midterm/blob/main/data_analysis.md).
#### Step 5E:
Look for associations between market cap (the indicator that the sites use to create their rankings) and volume and supply with linear regression by running [linear_regression.py](https://github.com/cbouts/ECON498_midterm/blob/main/data_analysis/linear_regression.py). For each website (represented by each CSV, [cmc_dataset.csv](https://github.com/cbouts/ECON498_midterm/blob/main/data_analysis/cmc_dataset.csv) and [gecko_dataset.csv](https://github.com/cbouts/ECON498_midterm/blob/main/data_analysis/gecko_dataset.csv)), the file uses market cap as data (x values) and regresses price and volume on market cap with a linear regression machine. The results of these regressions (coefficients and intercepts) are printed in the terminal, and they are presented and analyzed in [data_analysis.md](https://github.com/cbouts/ECON498_midterm/blob/main/data_analysis.md).


### Step 6 (BONUS):
#### Step 6A:
Request 1 year of historical data for each site by running the file [historical_request_2.py](https://github.com/cbouts/ECON498_midterm/blob/main/historical_request_2.py). 
...
```
Unlike the first request file, this file is requesting historical data for a pre-determined list of coins- that is, the coins that featured in the list of the top 500 coins during the 48 hour download period. To get and use this list of coins, we use the the dataset [cmc_deeplink.csv](https://github.com/cbouts/ECON498_midterm/blob/main/data_analysis/cmc_deeplink.csv). Before you do this, you need to move the csv back out of the data_analysis folder so that it is at the same level as the file. The next lines of code read the csv and find the names of the coins we will be requesting historical data for.
```
...
- (cmcap_historical_parse_4.py)[https://github.com/cbouts/ECON498_midterm/blob/main/cmcap_historical_parse_4.py]
- (historical_parse_gecko.py)[https://github.com/cbouts/ECON498_midterm/blob/main/historical_parse_gecko.py]

Because I couldn't parse this data, I included the html and json files in the folders [historical_html_files](https://github.com/cbouts/ECON498_midterm/tree/main/historical_html_files) and (historical_json_files)[https://github.com/cbouts/ECON498_midterm/tree/main/historical_json_files].
